  ...
  */
  ...
  _createClass(DocumentsApi, [{
    ...
    value: function mergeTemplate(template_id, data, opts, callback) {
      ...
      return this.apiClient.callApi('/templates/'+template_id+'/output', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    /**
